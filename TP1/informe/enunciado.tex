...
El análisis pedido consiste en llevar el circuito a un punto Q y de compensación determinados, para luego hacer un análisis de su THD en diferentes condiciones. En la figura~\figref{fig:fig_original_circuit} se observa el circuito propuesto.
